...
class CompileMetadata:
    ...
    profile_source: str
    raw_intent_hash: str
    # Resolution-time version tags (the 4-tuple's compiler/validators axes).
    # Default empty so the pure-function compile path stays unchanged when no
    # resolver metadata is threaded in.
