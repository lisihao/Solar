...
def _digest_report_item(run_dir: Path) -> dict:
    ...
    return {
        ...
        "mail": _ai_influence_mail_result(data.get("gmail", {}) if isinstance(data.get("gmail"), dict) else {"status": "unsent"}, None),
        "metrics": {
        ...
        items.append(
            {
                ...
                "final_url": ("/file/view?path=" + urllib.parse.quote(str(final_md))) if final_md.exists() else "",
